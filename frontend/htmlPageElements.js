// html elements
const htmlElement = {};
htmlElement.startButton = document.getElementById("startButton");
htmlElement.welcomePage = document.getElementById("welcomePage");
htmlElement.questionsPage = document.getElementById("questionsPage");
